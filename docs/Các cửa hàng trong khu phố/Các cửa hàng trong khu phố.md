...
<object id="myPdf" data="../Các cửa hàng trong khu phố.pdf" type="application/pdf" width="100%" height="800px" style="background-color: white;">
    <p>Trình duyệt của bạn không hỗ trợ xem PDF trực tiếp. <a href="../Các cửa hàng trong khu phố.pdf">Nhấn vào đây để tải về</a>.</p>
</object>
